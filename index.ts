...
interface ObjectProps {
    ...
    getConfirmedTransactions(): boolean[]
}
export class NonceTracker {
  // { provider<string>, blockTracker<string>, getPendingTransactions<function>, getConfirmedTransactions<function> }
  constructor (public properties: ObjectProps) {
    this.ethQuery = new EthQuery(properties.provider)
    this.lockMap = {}
  }
